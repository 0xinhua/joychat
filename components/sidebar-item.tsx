    ...
    >
      ...
      <Link
        ...
        className={cn(
          ...
          'group w-full font-normal px-2 transition-colors hover:bg-zinc-200 dark:hover:bg-zinc-300/80',
          isActive && 'bg-zinc-200/60 pr-16 font-semibold dark:bg-zinc-800'
        )}
      >
        <div
