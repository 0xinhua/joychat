...
function IconGoogle({
  ...
  return (
  <svg xmlns="http://www.w3.org/2000/svg" className={cn("h-4 w-4", className)} height="24" viewBox="0 0 24 24" width="24">
...
function IconOpenai({
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 26 26">
      <path
