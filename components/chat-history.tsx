    ...
    <div className="flex flex-col h-full">
      ...
      >
        ...
        <div className="fixed left-0 top-1/2 z-40 transform xl:translate-x-[256px] lg:translate-x-[220px]">
          <button onClick={() => {
            toggleSidebar()
          }} className="absolute inset-y-0 z-10 my-auto left-0 *:transition-transform group flex h-16 w-6 flex-col items-center justify-center -space-y-1 outline-none *:h-3 *:w-1 *:rounded-full *:hover:bg-gray-400 max-md:hidden dark:*:hover:bg-gray-800 *:bg-gray-200 dark:*:bg-gray-700">
