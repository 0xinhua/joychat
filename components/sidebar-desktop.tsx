  ...
  return (
    <Sidebar className="peer absolute inset-y-0 z-30 hidden -translate-x-full duration-300 ease-in-out data-[state=open]:translate-x-0 lg:flex lg:w-[240px] xl:w-[256px]">
      ...
      <Link
        ...
        >
        <div className="flex h-10 rounded-md px-2 py-4 w-full items-center justify-between font-medium hover:bg-zinc-200 dark:border-gray-800 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-700">
